...
if couplingON
    dirName = 'E:\WorkDocuments\C_Research\D_Programme_Code\Work_in_Git\clotlysis\TwoCompartCoupledLysisModel\';
...
figure('Name','Free Phase','Units','centimeter','Position',[0,15,45,10]);
subplot(2,4,1)
...
figure('Name','Bound Phase','Units','centimeter','Position',[0,1,25,10]);
subplot(231)
